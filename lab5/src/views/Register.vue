...
async function onSubmit() {
    try{
        await UserRepository.register(email.value, password.value);
      ...
      <div class='max-w-md w-full'>
        <div class='p-8 rounded-2xl bg-white shadow'>
          ...
          <form class='mt-8 space-y-4'>
            ...
            <p class='text-gray-800 text-sm !mt-8 text-center'>Already have an account?
              <RouterLink to='/login' class='text-blue-600 hover:underline ml-1 whitespace-nowrap font-semibold'>Log in here</RouterLink>
            </p>
          </form>
        </div>
      </div>
